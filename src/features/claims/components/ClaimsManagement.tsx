...
import { Eye, User, MapPin, Send, MessageSquare, Package, Check, X, Clock, AlertTriangle, ChevronLeft, ChevronRight } from 'lucide-react';
                ...
                <DialogContent className="max-w-7xl max-h-[95vh] flex flex-col">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-2 flex-1 overflow-hidden">
                        ...
                        <Card className="p-4 bg-slate-50 border-slate-200 h-full overflow-y-auto">
                            <h4 className="font-bold text-slate-800 mb-3 flex items-center gap-2 sticky top-0 bg-slate-50 z-10 py-1">
                        ...
                        <Card className="p-4 bg-white border-blue-100 h-full flex flex-col shadow-sm">
                            <h4 className="font-bold text-blue-800 mb-3 flex items-center gap-2 shrink-0">
                                <User className="w-4 h-4" /> Bằng chứng sinh viên
                            </h4>
                        ...
                        <Card className="p-4 bg-slate-50 border-slate-200 h-full flex flex-col">
