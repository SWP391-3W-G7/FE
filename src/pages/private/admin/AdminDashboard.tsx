...
const AdminDashboard = () => {
  ...
  const getCountValue = (item: any): number => {
    return typeof item?.count === 'object' ? item.count?.count || 0 : item?.count || 0;
  };
  ...
  const getStatusColor = (status: string, type: 'lost' | 'found' | 'claim') => {
    ...
    if (type === 'lost') {
      if (statusLower.includes('open') || statusLower.includes('lost')) return 'bg-orange-500';
      if (statusLower.includes('closed')) return 'bg-gray-400';
      if (statusLower.includes('found') || statusLower.includes('match')) return 'bg-green-500';
      return 'bg-blue-500';
    }
    ...
    if (type === 'claim') {
      if (statusLower.includes('pending')) return { bg: 'bg-orange-500', hex: '#f97316' };
      if (statusLower.includes('approved')) return { bg: 'bg-green-500', hex: '#22c55e' };
      if (statusLower.includes('rejected')) return { bg: 'bg-red-500', hex: '#ef4444' };
      if (statusLower.includes('returned')) return { bg: 'bg-blue-500', hex: '#3b82f6' };
      if (statusLower.includes('conflicted')) return { bg: 'bg-purple-500', hex: '#a855f7' };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="relative overflow-hidden group hover:shadow-lg transition-all duration-300 cursor-pointer border-l-4 border-l-orange-500">
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-sm font-medium text-slate-600">Đồ chưa trả</CardTitle>
            ...
            <CardContent>
              <div className="space-y-2">
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-bold text-slate-900">{unreturnedCount || 0}</span>
                ...
                <p className="text-xs text-slate-500 mt-2">Đồ nhặt được chưa được trả cho chủ nhân</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden group hover:shadow-lg transition-all duration-300 cursor-pointer border-l-4 border-l-red-500">
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-sm font-medium text-slate-600">Đồ thất lạc</CardTitle>
            ...
            <CardContent>
              <div className="space-y-2">
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-bold text-slate-900">{totalLostItems}</span>
                ...
                <p className="text-xs text-slate-500 mt-2">Người dùng báo cáo mất đồ</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden group hover:shadow-lg transition-all duration-300 cursor-pointer border-l-4 border-l-blue-500">
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-sm font-medium text-slate-600">Đồ nhặt được</CardTitle>
            ...
            <CardContent>
              <div className="space-y-2">
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-bold text-slate-900">{totalFoundItems}</span>
                  <span className="text-sm text-slate-500">items</span>
                </div>
                ...
                <p className="text-xs text-slate-500 mt-2">Đồ được nhặt và báo cáo</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden group hover:shadow-lg transition-all duration-300 cursor-pointer border-l-4 border-l-green-500">
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-sm font-medium text-slate-600">Yêu cầu nhận đồ</CardTitle>
            ...
            <CardContent>
              <div className="space-y-2">
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-bold text-slate-900">{totalClaims}</span>
                ...
                <p className="text-xs text-slate-500 mt-2">Yêu cầu nhận lại đồ thất lạc</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="shadow-md border-slate-200">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-lg font-semibold">Trạng thái đồ thất lạc</CardTitle>
                  <CardDescription className="text-sm">Phân bổ theo trạng thái</CardDescription>
                </div>
              ...
              {Array.isArray(lostItemsStats) && lostItemsStats.length > 0 ? (
                <div className="space-y-3">
                  {lostItemsStats.map((stat: any) => {
                    ...
                    const percentage = totalLostItems > 0 ? ((countValue / totalLostItems) * 100).toFixed(1) : '0';
                    const widthPercent = totalLostItems > 0 ? (countValue / totalLostItems) * 100 : 0;

                    return (
                      <div key={statusValue} className="space-y-2">
                        <div className="flex items-center justify-between text-sm">
                          <span className="font-medium text-slate-700">{statusValue}</span>
                          <div className="flex items-center gap-2">
                            <span className="text-xs text-slate-500">{percentage}%</span>
                            <Badge variant="secondary" className="text-xs">{countValue}</Badge>
                          </div>
                        </div>
          ...
          <Card className="shadow-md border-slate-200">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-lg font-semibold">Trạng thái đồ nhặt được</CardTitle>
                  <CardDescription className="text-sm">Phân bổ theo trạng thái</CardDescription>
                </div>
              ...
              {Array.isArray(foundItemsStats) && foundItemsStats.length > 0 ? (
                <div className="space-y-3">
                  {foundItemsStats.map((stat: any) => {
                    const statusValue = stat.status || stat.statusName || stat.scope;
                    const countValue = getCountValue(stat);
                    const percentage = totalFoundItems > 0 ? ((countValue / totalFoundItems) * 100).toFixed(1) : '0';
                    const widthPercent = totalFoundItems > 0 ? (countValue / totalFoundItems) * 100 : 0;
          ...
          <Card className="shadow-md border-slate-200">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-lg font-semibold">Trạng thái yêu cầu</CardTitle>
                  <CardDescription className="text-sm">Phân bổ theo trạng thái</CardDescription>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-center">
                    <div className="relative w-40 h-40">
                      <svg viewBox="0 0 200 200" className="w-full h-full transform -rotate-90">
                        {(() => {
                          ...
                          return claimStats.map((stat: any) => {
                            ...
                            const color = typeof colors === 'object' ? colors.hex : '#9ca3af';
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center">
                        <span className="text-2xl font-bold text-slate-900">{totalClaims}</span>
                  ...
                  <div className="space-y-2">
                    {claimStats.map((stat: any) => {
                      const statusValue = stat.status || stat.statusName || stat.scope;
                      const countValue = getCountValue(stat);
                      const percentage = totalClaims > 0 ? ((countValue / totalClaims) * 100).toFixed(1) : '0';
                      const colors = getStatusColor(statusValue, 'claim');
                      const bgColor = typeof colors === 'object' ? colors.bg : 'bg-gray-400';

                      return (
                        <div key={statusValue} className="flex items-center justify-between text-sm">
                          <div className="flex items-center gap-2">
                            <div className={`w-3 h-3 rounded-full ${bgColor}`}></div>
                            <span className="text-slate-700 text-xs">{statusValue}</span>
                          </div>
                          <div className="flex items-center gap-2">
                            <span className="text-xs text-slate-500">{percentage}%</span>
                            <Badge variant="outline" className="text-xs">{countValue}</Badge>
                          </div>
                        </div>
                      );
                    })}
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription className="text-sm">12 tháng gần nhất</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              {Array.isArray(monthlyData) && monthlyData.length > 0 ? (
                <div className="space-y-4">
                  ...
                  <svg viewBox="0 0 600 250" className="w-full h-64">
                    ...
                    {[0, 1, 2, 3, 4].map((i) => (
                      <g key={i}>
                        <line x1="60" y1={40 + i * 40} x2="580" y2={40 + i * 40} stroke="#e2e8f0" strokeWidth="1" />
                        <text x="45" y={45 + i * 40} fontSize="11" fill="#94a3b8" textAnchor="end">
                          {(() => {
                            const maxValue = Math.max(...monthlyData.map((item: any) => getCountValue(item)), 1);
                    ...
                    {(() => {
                      ...
                      const points = monthlyData.map((item: any, index: number) => {
                        ...
                        return { x, y, count: countValue, month: item.month || item.name };
                      });
                            ...
                            <g key={i}>
                              ...
                              {p.x === maxPoint.x && (
                                <g>
                                  ...
                                  <text x={p.x} y={p.y - 15} fontSize="11" fill="#3b82f6" fontWeight="600" textAnchor="middle">
                                    {p.count}
                                  </text>
                                </g>
                              )}
                    ...
                    {monthlyData.map((item: any, index: number) => {
                      ...
                      return (
                        <text key={index} x={60 + index * xStep} y="230" fontSize="10" fill="#64748b" textAnchor="middle">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-slate-500">Không có dữ liệu xu hướng</p>
                </div>
              )}
            </CardContent>
          </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription className="text-sm">Người dùng báo cáo nhiều nhất</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              {Array.isArray(topContributors) && topContributors.length > 0 ? (
                <div className="space-y-3">
                  {topContributors.slice(0, 5).map((user: any, index: number) => {
                    const countValue = user.itemCount || getCountValue(user);

                    const rankStyles = [
                      { bg: 'bg-gradient-to-br from-yellow-400 to-yellow-600', text: 'text-white', icon: '🥇' },
                      { bg: 'bg-gradient-to-br from-slate-300 to-slate-500', text: 'text-white', icon: '🥈' },
                      { bg: 'bg-gradient-to-br from-orange-400 to-orange-600', text: 'text-white', icon: '🥉' },
                      { bg: 'bg-slate-100', text: 'text-slate-700', icon: index + 1 },
                      { bg: 'bg-slate-100', text: 'text-slate-700', icon: index + 1 },
                    ];

                    const style = rankStyles[index] || { bg: 'bg-slate-100', text: 'text-slate-700', icon: index + 1 };

                    return (
                      <div key={user.userId || index} className="flex items-center justify-between p-3 rounded-lg bg-slate-50 hover:bg-slate-100 transition-colors">
                        <div className="flex items-center gap-3">
                          <div className={`w-10 h-10 rounded-lg flex items-center justify-center text-sm font-bold ${style.bg} ${style.text} shadow-sm`}>
                            {style.icon}
                          </div>
                          <div>
                            <div className="text-sm font-semibold text-slate-900">{user.userName || user.fullName}</div>
                            <div className="text-xs text-slate-500">{user.email}</div>
                          </div>
                        </div>
                        <div className="flex items-center gap-2">
                          <Badge className="bg-blue-500 text-white font-semibold">{countValue} đồ</Badge>
                          <Button size="sm" variant="ghost" onClick={() => handleOpenDetailDialog(user.userId)} className="h-8 w-8 p-0">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-slate-500">Chưa có người đóng góp</p>
                </div>
              )}
            </CardContent>
          </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription className="text-sm">Khu vực cần chú ý</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              {Array.isArray(campusLostItems) && campusLostItems.length > 0 ? (
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="hover:bg-transparent">
                        ...
                        <TableHead className="text-right font-semibold">Mức độ</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {campusLostItems.map((campus: any, index: number) => {
                        const countValue = campus.lostItemCount || getCountValue(campus);
                        const maxCount = Math.max(...campusLostItems.map((c: any) => c.lostItemCount || getCountValue(c)));
                        const riskLevel = countValue > maxCount * 0.7 ? 'high' : countValue > maxCount * 0.4 ? 'medium' : 'low';

                        return (
                          <TableRow key={campus.campusId || campus.campusName} className="hover:bg-slate-50">
                            <TableCell>
                              <div className="flex items-center gap-2">
                                <div className={`w-2 h-2 rounded-full ${
                                  riskLevel === 'high' ? 'bg-red-500' : riskLevel === 'medium' ? 'bg-orange-500' : 'bg-green-500'
                                }`} />
                                <span className="font-medium text-slate-900">{campus.campusName}</span>
                              </div>
                            </TableCell>
                            <TableCell className="text-right">
                              <span className="text-lg font-bold text-slate-900">{countValue}</span>
                            </TableCell>
                            <TableCell className="text-right">
                              {riskLevel === 'high' ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-slate-500">Không có dữ liệu campus</p>
                </div>
              )}
            </CardContent>
          </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription className="text-sm">Cần hỗ trợ và theo dõi</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              {Array.isArray(userLostItems) && userLostItems.length > 0 ? (
                <div className="space-y-3">
                  {userLostItems.slice(0, 5).map((user: any, index: number) => {
                    const countValue = user.lostItemCount || getCountValue(user);

                    const rankStyles = [
                      { bg: 'bg-gradient-to-br from-purple-400 to-purple-600', text: 'text-white', icon: '1' },
                      { bg: 'bg-gradient-to-br from-purple-300 to-purple-500', text: 'text-white', icon: '2' },
                      { bg: 'bg-gradient-to-br from-purple-200 to-purple-400', text: 'text-white', icon: '3' },
                      { bg: 'bg-purple-100', text: 'text-purple-700', icon: index + 1 },
                      { bg: 'bg-purple-100', text: 'text-purple-700', icon: index + 1 },
                    ];

                    const style = rankStyles[index] || { bg: 'bg-purple-100', text: 'text-purple-700', icon: index + 1 };

                    return (
                      <div key={user.userId || user.userName} className="flex items-center justify-between p-3 rounded-lg bg-slate-50 hover:bg-slate-100 transition-colors">
                        <div className="flex items-center gap-3">
                          <div className={`w-10 h-10 rounded-lg flex items-center justify-center text-sm font-bold ${style.bg} ${style.text} shadow-sm`}>
                            {style.icon}
                          </div>
                        ...
                        <div className="flex items-center gap-2">
                          <Badge className="bg-purple-500 text-white font-semibold">{countValue} reports</Badge>
                          <Button size="sm" variant="ghost" onClick={() => handleOpenDetailDialog(user.userId)} className="h-8 w-8 p-0">
                            <Eye className="h-4 w-4" />
                          </Button>
                        </div>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-slate-500">Không có dữ liệu người dùng</p>
                </div>
              )}
            </CardContent>
          </Card>
      ...
      <Dialog open={detailDialogOpen} onOpenChange={setDetailDialogOpen}>
        <DialogContent className="sm:max-w-[650px] max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-xl font-semibold">Thông tin chi tiết người dùng</DialogTitle>
          </DialogHeader>
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                  <p className="text-xs font-medium text-slate-500 uppercase mb-1">User ID</p>
                  <p className="text-base font-semibold text-slate-900">{userDetail.userId}</p>
                </div>
                
                <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                  <p className="text-xs font-medium text-slate-500 uppercase mb-1">Username</p>
                  <p className="text-base font-semibold text-slate-900">{userDetail.username}</p>
                </div>
                
                <div className="bg-slate-50 rounded-lg p-4 border border-slate-200 sm:col-span-2">
                  <p className="text-xs font-medium text-slate-500 uppercase mb-1">Họ và tên</p>
                  <p className="text-base font-semibold text-slate-900">{userDetail.fullName}</p>
                </div>
                
                <div className="bg-slate-50 rounded-lg p-4 border border-slate-200 sm:col-span-2">
                  <p className="text-xs font-medium text-slate-500 uppercase mb-1">Email</p>
                  <p className="text-base font-semibold text-slate-900 break-all">{userDetail.email}</p>
                </div>
                
                <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                  <p className="text-xs font-medium text-slate-500 uppercase mb-1">Số điện thoại</p>
                ...
                <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                  <p className="text-xs font-medium text-slate-500 uppercase mb-1">Vai trò</p>
                  <p className="text-base font-semibold text-slate-900">
                ...
                <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                  <p className="text-xs font-medium text-slate-500 uppercase mb-1">Campus</p>
                  <p className="text-base font-semibold text-slate-900">
                ...
                <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                  <p className="text-xs font-medium text-slate-500 uppercase mb-1">Trạng thái</p>
                  <div className="mt-1">
