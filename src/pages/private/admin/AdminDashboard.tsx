...
import { Package, FileQuestion, Archive, CheckCircle2, Clock, MapPin, Users, TrendingUp, Trophy, AlertCircle, Eye } from 'lucide-react';
                ...
                <div className="flex justify-center">
                  <svg viewBox="0 0 200 200" className="w-64 h-64">
                    {(() => {
                      ...
                      return claimStats.map((stat: any, index: number) => {
                        const statusValue = stat.status || stat.statusName || stat.scope;
                        const countValue = typeof stat.count === 'object' ? stat.count?.count || 0 : stat.count || 0;
