...
const AdminHeader = ({ onMenuClick, onToggleSidebar, isCollapsed }: AdminHeaderProps) => {
        ...
        <header className="h-16 border-b bg-white flex items-center justify-between px-4 sticky top-0 z-30">
            <div className="flex items-center gap-4">
                ...
                <Button
                    variant="ghost"
                    size="icon"
                    className="hidden md:flex text-slate-400 hover:text-indigo-600"
                ...
                <div className="hidden lg:flex items-center relative w-64">
                    ...
                    <Input
                        ...
                        className="pl-9 bg-slate-50 border-none focus-visible:ring-1 focus-visible:ring-indigo-500 h-9 text-sm"
                    />
                </div>
            </div>
                    ...
                    <DropdownMenuContent className="w-56" align="end">
                        <DropdownMenuLabel>
                            <div className="flex flex-col space-y-1">
                                ...
                                <Badge variant="secondary" className="mt-1 w-fit text-[10px] uppercase bg-indigo-50 text-indigo-700">
                                    {user?.role}
                                </Badge>
                            </div>
                        </DropdownMenuLabel>
